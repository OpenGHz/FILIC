...
def environment_maker(config: dict):
    from envs.mock_env import make_env
...
chunk_size = 25
camera_names = ["cam_eye_arm", "cam_eye_side"]
TASK_CONFIG_DEFAULT["common"]["camera_names"] = camera_names
TASK_CONFIG_DEFAULT["common"]["state_dim"] = 6
TASK_CONFIG_DEFAULT["common"]["action_dim"] = 3
...
TASK_CONFIG_DEFAULT["train"]["load_data"]["batch_size_train"] = 128
TASK_CONFIG_DEFAULT["train"]["load_data"]["batch_size_validate"] = 128
